...
const COLS =
  ...
  'image_width, image_height, image_bytes, uploaded_by, is_active, created_at, updated_at, batch_id';
  ...
  const sql = `
    INSERT INTO ${TABLE}
      (facility_id, template_id, label, image_path, image_url, image_mime,
       image_width, image_height, image_bytes, embedding, uploaded_by, batch_id)
